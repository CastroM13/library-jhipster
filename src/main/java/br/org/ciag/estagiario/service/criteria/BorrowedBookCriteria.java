...
/**
 * Criteria class for the {@link br.org.ciag.estagiario.domain.BorrowedBook} entity. This class is used
 * in {@link br.org.ciag.estagiario.web.rest.BorrowedBookResource} to receive all the possible filtering options from
...
public class BorrowedBookCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, borrowDate, bookId, clientId);
    }
